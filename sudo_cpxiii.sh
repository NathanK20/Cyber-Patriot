...
if [ $mediaFilesYN == no ]
then
	sudo find / -name "*.midi" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mid" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mod" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mp3" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mp2" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mpa" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.abs" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mpega" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.au" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.snd" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wav" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.aiff" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.aif" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.sid" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.flac" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.ogg" -type f >> ~/Desktop/Script.log
	clear
	printTime "All audio files has been listed."

	sudo find / -name "*.mpeg" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mpg" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mpe" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.dl" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.movie" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.movi" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mv" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.iff" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.anim5" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.anim3" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.anim7" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.avi" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.vfw" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.avx" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.fli" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.flc" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mov" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.qt" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.spl" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.swf" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.dcr" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.dir" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.dxr" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.rpm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.rm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.smi" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.ra" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.ram" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.rv" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wmv" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.asf" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.asx" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wma" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wax" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wmv" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.wmx" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.3gp" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mov" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.mp4" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.avi" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.swf" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.flv" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.m4v" -type f >> ~/Desktop/Script.log
	clear
	printTime "All video files have been listed."
	
	sudo find / -name "*.tiff" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.tif" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.rs" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.im1" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.gif" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.jpeg" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.jpg" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.jpe" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.png" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.rgb" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.xwd" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.xpm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.ppm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.pbm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.pgm" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.pcx" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.ico" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.svg" -type f >> ~/Desktop/Script.log
	sudo find / -name "*.svgz" -type f >> ~/Desktop/Script.log
	clear
...
clear
sudo find / -type f -perm 777 >> ~/Desktop/Script.log
sudo find / -type f -perm 776 >> ~/Desktop/Script.log
sudo find / -type f -perm 775 >> ~/Desktop/Script.log
sudo find / -type f -perm 774 >> ~/Desktop/Script.log
sudo find / -type f -perm 773 >> ~/Desktop/Script.log
sudo find / -type f -perm 772 >> ~/Desktop/Script.log
sudo find / -type f -perm 771 >> ~/Desktop/Script.log
sudo find / -type f -perm 770 >> ~/Desktop/Script.log
sudo find / -type f -perm 767 >> ~/Desktop/Script.log
sudo find / -type f -perm 766 >> ~/Desktop/Script.log
sudo find / -type f -perm 765 >> ~/Desktop/Script.log
sudo find / -type f -perm 764 >> ~/Desktop/Script.log
sudo find / -type f -perm 763 >> ~/Desktop/Script.log
sudo find / -type f -perm 762 >> ~/Desktop/Script.log
sudo find / -type f -perm 761 >> ~/Desktop/Script.log
sudo find / -type f -perm 760 >> ~/Desktop/Script.log
sudo find / -type f -perm 757 >> ~/Desktop/Script.log
sudo find / -type f -perm 756 >> ~/Desktop/Script.log
sudo find / -type f -perm 755 >> ~/Desktop/Script.log
sudo find / -type f -perm 754 >> ~/Desktop/Script.log
sudo find / -type f -perm 753 >> ~/Desktop/Script.log
sudo find / -type f -perm 752 >> ~/Desktop/Script.log
sudo find / -type f -perm 751 >> ~/Desktop/Script.log
sudo find / -type f -perm 750 >> ~/Desktop/Script.log
sudo find / -type f -perm 747 >> ~/Desktop/Script.log
sudo find / -type f -perm 746 >> ~/Desktop/Script.log
sudo find / -type f -perm 745 >> ~/Desktop/Script.log
sudo find / -type f -perm 744 >> ~/Desktop/Script.log
sudo find / -type f -perm 743 >> ~/Desktop/Script.log
sudo find / -type f -perm 742 >> ~/Desktop/Script.log
sudo find / -type f -perm 741 >> ~/Desktop/Script.log
sudo find / -type f -perm 740 >> ~/Desktop/Script.log
sudo find / -type f -perm 737 >> ~/Desktop/Script.log
sudo find / -type f -perm 736 >> ~/Desktop/Script.log
sudo find / -type f -perm 735 >> ~/Desktop/Script.log
sudo find / -type f -perm 734 >> ~/Desktop/Script.log
sudo find / -type f -perm 733 >> ~/Desktop/Script.log
sudo find / -type f -perm 732 >> ~/Desktop/Script.log
sudo find / -type f -perm 731 >> ~/Desktop/Script.log
sudo find / -type f -perm 730 >> ~/Desktop/Script.log
sudo find / -type f -perm 727 >> ~/Desktop/Script.log
sudo find / -type f -perm 726 >> ~/Desktop/Script.log
sudo find / -type f -perm 725 >> ~/Desktop/Script.log
sudo find / -type f -perm 724 >> ~/Desktop/Script.log
sudo find / -type f -perm 723 >> ~/Desktop/Script.log
sudo find / -type f -perm 722 >> ~/Desktop/Script.log
sudo find / -type f -perm 721 >> ~/Desktop/Script.log
sudo find / -type f -perm 720 >> ~/Desktop/Script.log
sudo find / -type f -perm 717 >> ~/Desktop/Script.log
sudo find / -type f -perm 716 >> ~/Desktop/Script.log
sudo find / -type f -perm 715 >> ~/Desktop/Script.log
sudo find / -type f -perm 714 >> ~/Desktop/Script.log
sudo find / -type f -perm 713 >> ~/Desktop/Script.log
sudo find / -type f -perm 712 >> ~/Desktop/Script.log
sudo find / -type f -perm 711 >> ~/Desktop/Script.log
sudo find / -type f -perm 710 >> ~/Desktop/Script.log
sudo find / -type f -perm 707 >> ~/Desktop/Script.log
sudo find / -type f -perm 706 >> ~/Desktop/Script.log
sudo find / -type f -perm 705 >> ~/Desktop/Script.log
sudo find / -type f -perm 704 >> ~/Desktop/Script.log
sudo find / -type f -perm 703 >> ~/Desktop/Script.log
sudo find / -type f -perm 702 >> ~/Desktop/Script.log
sudo find / -type f -perm 701 >> ~/Desktop/Script.log
sudo find / -type f -perm 700 >> ~/Desktop/Script.log
printTime "All files with file permissions between 700 and 777 have been listed above."

clear
sudo find / -name "*.php" -type f >> ~/Desktop/Script.log
...
sudo find . -type f -exec grep -Iq . {} \; -and -print >> Desktop/Comparatives/alltextfiles.txt
